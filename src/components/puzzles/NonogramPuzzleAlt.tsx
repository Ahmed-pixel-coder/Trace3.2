...
// New variation for the other team
const SOLUTION = [
  [0, 1, 1, 0],
  [1, 1, 0, 1],
  [1, 0, 1, 1],
...
const NonogramPuzzleAlt: React.FC<NonogramPuzzleProps> = ({ onComplete, isCompleted }) => {
  ...
  return (
    <div className="text-center">
      <div className="mb-6">
        <h3 className="text-lg font-bold text-green-400 mb-2">NONOGRAM PUZZLE (ALT)</h3>
...
export default NonogramPuzzleAlt;
